package org.julclang.vm.truffle;
...
import org.julclang.vm.ProtocolFeatureRegistry;
...
/**
 * Runs the official Plutus conformance test suite against the Truffle CEK machine.
 * <p>
 * Same test structure as {@code julc-vm-java}'s PlutusConformanceTest.
 */
class PlutusConformanceTest {
    ...
    private void runConformanceTest(
        ...
        verifyBudget(budgetFile, result, input);
    }

    private void verifyBudget(Path budgetFile, EvalResult result, String input) throws IOException {
    ...
    // --- Structural equality (same as Java VM conformance test) ---
