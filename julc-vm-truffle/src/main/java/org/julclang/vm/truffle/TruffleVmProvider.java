...
import org.julclang.vm.java.cost.*;
import org.julclang.vm.truffle.convert.NodeToTermConverter;
import org.julclang.vm.truffle.convert.TermToNodeConverter;
import org.julclang.vm.truffle.node.UplcNode;
import org.julclang.vm.truffle.node.UplcRootNode;
...
public class TruffleVmProvider implements JulcVmProvider {
    ...
    private EvalResult evaluateInternal(Program program, LedgerEvaluationTarget target,
        ...
        } catch (org.julclang.vm.java.CekEvaluationException e) {
