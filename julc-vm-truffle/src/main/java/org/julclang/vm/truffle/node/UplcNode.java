...
public abstract class UplcNode extends Node implements InstrumentableNode {
     ...
     * Return types:
     * <ul>
     *   <li>{@link org.julclang.core.Constant} — constant values</li>
     *   <li>{@link org.julclang.vm.truffle.runtime.UplcClosure} — lambda closures</li>
     *   <li>{@link org.julclang.vm.truffle.runtime.UplcDelay} — delayed thunks</li>
     *   <li>{@link org.julclang.vm.truffle.runtime.UplcBuiltinDescriptor} — partial builtins</li>
     *   <li>{@link org.julclang.vm.truffle.runtime.UplcConstrValue} — constructor values</li>
     * </ul>
     */
