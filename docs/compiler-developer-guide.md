...
**Navigation:**
- **Part I** (Sections 1–4): Start here if you're new to the compiler
- **Part II** (Sections 5–13): The compilation pipeline, phase by phase
- **Part III** (Sections 14–17): Deep dives into specific subsystems
- **Part IV** (Sections 18–24): Step-by-step how-to recipes
- **Part V** (Sections 25–30): Troubleshooting and reference
