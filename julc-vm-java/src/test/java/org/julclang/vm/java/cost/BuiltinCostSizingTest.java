...
import org.julclang.vm.BuiltinSemanticsVariant;
...
class BuiltinCostSizingTest {
    ...
    private static org.julclang.vm.ExBudget charge(DefaultFun fun, CekValue... args) {
    ...
    private static CekValue listArg(int len) {
        ...
        return new CekValue.VCon(new Constant.ListConst(
                org.julclang.core.DefaultUni.INTEGER, items));
    }
