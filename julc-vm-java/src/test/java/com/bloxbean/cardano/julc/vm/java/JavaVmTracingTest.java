...
/**
 * Tests for execution tracing in the Java VM backend.
 */
class JavaVmTracingTest {
    ...
    @Test
    void tracingWithSourceMap_producesEntries() {
    ...
    @Test
    void traceIsolationBetweenEvaluations() {
