package org.julclang.cli.mcp.tools;
...
class EvaluateToolTest {
    ...
    void parses_recursive_constr_arg() {
        ...
        assertEquals(1, pds.size());
        var pd = pds.get(0);
        assertInstanceOf(org.julclang.core.PlutusData.ConstrData.class, pd);
    }
    ...
    void parses_recursive_list_arg() {
        ...
        var pds = EvaluateTool.parseArgs(raw);
        assertEquals(1, pds.size());
        assertInstanceOf(org.julclang.core.PlutusData.ListData.class, pds.get(0));
    }
    ...
    void parses_recursive_map_arg() {
        ...
        var pds = EvaluateTool.parseArgs(raw);
        assertEquals(1, pds.size());
        assertInstanceOf(org.julclang.core.PlutusData.MapData.class, pds.get(0));
    }
