...
class MethodDocExtractorTest {
    ...
    @BeforeAll
    static void setup() {
        extractor = new MethodDocExtractor(org.julclang.compiler.LibrarySourceResolver.librarySourcesFrom(Map.of(
    ...
    void realLibraryPool_mathLibPow() {
        var pool = org.julclang.compiler.LibrarySourceResolver.scanClasspathSources(
