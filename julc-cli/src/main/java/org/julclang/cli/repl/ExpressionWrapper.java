...
public final class ExpressionWrapper {
    ...
    private static String buildSource(String body, String returnType, List<String> userImports) {
        ...
        // Core types
        sb.append("import org.julclang.core.PlutusData;\n");
        sb.append("import org.julclang.core.types.JulcList;\n");
        sb.append("import org.julclang.core.types.JulcMap;\n");
        sb.append("import org.julclang.core.types.Tuple2;\n");
        sb.append("import org.julclang.core.types.Tuple3;\n");

        // Ledger types (wildcard)
        sb.append("import org.julclang.ledger.*;\n");
