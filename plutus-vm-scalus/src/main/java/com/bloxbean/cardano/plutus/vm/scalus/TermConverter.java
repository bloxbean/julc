...
final class TermConverter {
    ...
    static com.bloxbean.cardano.plutus.core.DefaultUni fromScalusDefaultUni(scalus.uplc.DefaultUni uni) {
        if (uni == scalus.uplc.DefaultUni.Integer$.MODULE$) return com.bloxbean.cardano.plutus.core.DefaultUni.INTEGER;
        if (uni == scalus.uplc.DefaultUni.ByteString$.MODULE$) return com.bloxbean.cardano.plutus.core.DefaultUni.BYTESTRING;
        if (uni == scalus.uplc.DefaultUni.String$.MODULE$) return com.bloxbean.cardano.plutus.core.DefaultUni.STRING;
        if (uni == scalus.uplc.DefaultUni.Unit$.MODULE$) return com.bloxbean.cardano.plutus.core.DefaultUni.UNIT;
        if (uni == scalus.uplc.DefaultUni.Bool$.MODULE$) return com.bloxbean.cardano.plutus.core.DefaultUni.BOOL;
        if (uni == scalus.uplc.DefaultUni.Data$.MODULE$) return com.bloxbean.cardano.plutus.core.DefaultUni.DATA;
        if (uni == scalus.uplc.DefaultUni.ProtoList$.MODULE$) return new com.bloxbean.cardano.plutus.core.DefaultUni.ProtoList();
        if (uni == scalus.uplc.DefaultUni.ProtoPair$.MODULE$) return new com.bloxbean.cardano.plutus.core.DefaultUni.ProtoPair();
        if (uni instanceof scalus.uplc.DefaultUni.Apply a) {
            return new com.bloxbean.cardano.plutus.core.DefaultUni.Apply(
