    ...
    static StdlibLookup testStdlibLookup() {
        return (className, methodName, args) -> {
            ...
            if ("ContextsLib".equals(className) && "signedBy".equals(methodName) && args.size() == 2) {
                ...
                var txInfoVar = new PirTerm.Var("txInfo_sb", new com.bloxbean.cardano.plutus.compiler.pir.PirType.DataType());
                var pkhVar = new PirTerm.Var("pkh_sb", new com.bloxbean.cardano.plutus.compiler.pir.PirType.DataType());
                ...
                // Recursive search
                var sigListVar = new PirTerm.Var("sigList_sb", new com.bloxbean.cardano.plutus.compiler.pir.PirType.ListType(new com.bloxbean.cardano.plutus.compiler.pir.PirType.DataType()));
                var targetVar = new PirTerm.Var("target_sb", new com.bloxbean.cardano.plutus.compiler.pir.PirType.ByteStringType());
                var goVar = new PirTerm.Var("go_sb", new com.bloxbean.cardano.plutus.compiler.pir.PirType.FunType(
                        new com.bloxbean.cardano.plutus.compiler.pir.PirType.ListType(new com.bloxbean.cardano.plutus.compiler.pir.PirType.DataType()),
                        new com.bloxbean.cardano.plutus.compiler.pir.PirType.BoolType()));
                ...
                var goBody = new PirTerm.Lam("sigList_sb", new com.bloxbean.cardano.plutus.compiler.pir.PirType.ListType(new com.bloxbean.cardano.plutus.compiler.pir.PirType.DataType()), body);
                var sigsVar = new PirTerm.Var("sigs_sb", new com.bloxbean.cardano.plutus.compiler.pir.PirType.ListType(new com.bloxbean.cardano.plutus.compiler.pir.PirType.DataType()));
