...
class JulcVmTest {
    ...
    /**
     * A mock provider for testing the JulcVm facade.
     */
    static class MockProvider implements JulcVmProvider {
    ...
    void withProviderDefaultsToV3() {
        ...
        var vm = JulcVm.withProvider(mock);
    ...
    void withProviderAndLanguage() {
        var mock = new MockProvider();
        var vm = JulcVm.withProvider(mock, PlutusLanguage.PLUTUS_V1);
    ...
    void evaluatePassesLanguage() {
        var mock = new MockProvider();
        var vm = JulcVm.withProvider(mock, PlutusLanguage.PLUTUS_V2);
    ...
    void createWithNoProviderThrows() {
        ...
        assertThrows(IllegalStateException.class, JulcVm::create);
    }
