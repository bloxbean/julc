...
import org.julclang.playground.java.JavaMetadataExtractor;
...
public final class PlaygroundService {
     ...
     */
    public PlaygroundService(JulcCompiler julcCompiler, Map<String, LibrarySource> cachedLibSources,
    ...
    public static ServiceResult<EvalExpressionResponse> evalExpression(PlaygroundEvaluator evaluator,
    ...
    // ---------------------------------------------------------------- GET /api/scenarios/{purpose}

    /** Test scenario templates for a script purpose. */
