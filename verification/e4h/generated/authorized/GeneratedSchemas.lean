...
inductive AuthorizedThresholdGateDatum where
  | Datum
deriving Repr

instance : IsData AuthorizedThresholdGateDatum where
  toData
...
inductive AuthorizedThresholdGateRedeemer where
  | Redeemer
deriving Repr

instance : IsData AuthorizedThresholdGateRedeemer where
  toData
