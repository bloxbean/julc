...
def dslGuarantee_authorization_two_of_three_threshold (ctx : ScriptContext) : Bool :=
...
def dslProperty_authorization_two_of_three_threshold (ctx : ScriptContext) : Prop :=
  dslGuarantee_authorization_two_of_three_threshold ctx = true
