...
lake env lean -o .lake/build/lib/lean/AuthorizedThresholdGate_authorization_two_of_three_thresholdObligation.olean AuthorizedThresholdGate_authorization_two_of_three_thresholdObligation.lean

set +e
lake env lean AuthorizedThresholdGate_authorization_two_of_three_thresholdNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean AuthorizedThresholdGate_authorization_two_of_three_thresholdVacuityProof.lean; then
