...
This generator-owned workspace checks `AuthorizedThresholdGate` against `1` independently
named schema-3 properties from `verification/e4h/AuthorizedThresholdSpec.java`. The worker-produced AST was strictly
