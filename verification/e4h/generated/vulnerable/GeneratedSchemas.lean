...
inductive VulnerableThresholdGateDatum where
  | Datum
deriving Repr

instance : IsData VulnerableThresholdGateDatum where
  toData
...
inductive VulnerableThresholdGateRedeemer where
  | Redeemer
deriving Repr

instance : IsData VulnerableThresholdGateRedeemer where
  toData
