...
This generator-owned workspace checks `VulnerableThresholdGate` against `1` independently
named schema-3 properties from `verification/e4h/VulnerableThresholdSpec.java`. The worker-produced AST was strictly
