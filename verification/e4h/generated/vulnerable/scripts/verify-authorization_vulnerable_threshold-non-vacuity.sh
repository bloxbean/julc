...
lake env lean -o .lake/build/lib/lean/VulnerableThresholdGate_authorization_vulnerable_thresholdObligation.olean VulnerableThresholdGate_authorization_vulnerable_thresholdObligation.lean

set +e
lake env lean VulnerableThresholdGate_authorization_vulnerable_thresholdNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean VulnerableThresholdGate_authorization_vulnerable_thresholdVacuityProof.lean; then
