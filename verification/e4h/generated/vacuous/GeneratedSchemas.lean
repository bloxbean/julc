...
inductive VacuousThresholdGateDatum where
  | Datum
deriving Repr

instance : IsData VacuousThresholdGateDatum where
  toData
...
inductive VacuousThresholdGateRedeemer where
  | Redeemer
deriving Repr

instance : IsData VacuousThresholdGateRedeemer where
  toData
