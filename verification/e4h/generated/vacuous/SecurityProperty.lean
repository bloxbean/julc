...
def dslGuarantee_authorization_vacuous (ctx : ScriptContext) : Bool :=
  julcAtLeastSigned 2 ([("\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41\x41" : ByteString), ("\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42\x42" : ByteString), ("\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43\x43" : ByteString)]) ctx.scriptContextTxInfo.txInfoSignatories

def dslProperty_authorization_vacuous (ctx : ScriptContext) : Prop :=
  dslGuarantee_authorization_vacuous ctx = true
