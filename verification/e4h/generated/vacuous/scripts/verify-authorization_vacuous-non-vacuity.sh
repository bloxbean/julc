...
lake env lean -o .lake/build/lib/lean/VacuousThresholdGate_authorization_vacuousObligation.olean VacuousThresholdGate_authorization_vacuousObligation.lean

set +e
lake env lean VacuousThresholdGate_authorization_vacuousNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean VacuousThresholdGate_authorization_vacuousVacuityProof.lean; then
