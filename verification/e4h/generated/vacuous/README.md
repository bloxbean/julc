...
This generator-owned workspace checks `VacuousThresholdGate` against `1` independently
named schema-3 properties from `verification/e4h/VacuousThresholdSpec.java`. The worker-produced AST was strictly
