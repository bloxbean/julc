...
lake env lean -o .lake/build/lib/lean/AuthorizedLedgerContextGate_ledger_context_feeObligation.olean AuthorizedLedgerContextGate_ledger_context_feeObligation.lean

set +e
lake env lean AuthorizedLedgerContextGate_ledger_context_feeNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean AuthorizedLedgerContextGate_ledger_context_feeVacuityProof.lean; then
