...
lake env lean -o .lake/build/lib/lean/AuthorizedLedgerContextGate_ledger_context_reference_shapeObligation.olean AuthorizedLedgerContextGate_ledger_context_reference_shapeObligation.lean

set +e
lake env lean AuthorizedLedgerContextGate_ledger_context_reference_shapeNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean AuthorizedLedgerContextGate_ledger_context_reference_shapeVacuityProof.lean; then
