...
lake env lean -o .lake/build/lib/lean/VulnerableLedgerContextGate_ledger_context_vulnerableObligation.olean VulnerableLedgerContextGate_ledger_context_vulnerableObligation.lean

set +e
lake env lean VulnerableLedgerContextGate_ledger_context_vulnerableNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean VulnerableLedgerContextGate_ledger_context_vulnerableVacuityProof.lean; then
