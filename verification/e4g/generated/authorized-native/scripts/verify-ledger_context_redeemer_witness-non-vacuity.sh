...
lake env lean -o .lake/build/lib/lean/AuthorizedLedgerContextGate_ledger_context_redeemer_witnessObligation.olean AuthorizedLedgerContextGate_ledger_context_redeemer_witnessObligation.lean

set +e
lake env lean AuthorizedLedgerContextGate_ledger_context_redeemer_witnessNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean AuthorizedLedgerContextGate_ledger_context_redeemer_witnessVacuityProof.lean; then
