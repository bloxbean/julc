...
inductive AuthorizedLedgerContextGateDatum where
  | Datum
deriving Repr

instance : IsData AuthorizedLedgerContextGateDatum where
  toData
...
inductive AuthorizedLedgerContextGateRedeemer where
  | Redeemer
deriving Repr

instance : IsData AuthorizedLedgerContextGateRedeemer where
  toData
