...
lake env lean -o .lake/build/lib/lean/VacuousLedgerContextGate_ledger_context_vacuousObligation.olean VacuousLedgerContextGate_ledger_context_vacuousObligation.lean

set +e
lake env lean VacuousLedgerContextGate_ledger_context_vacuousNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean VacuousLedgerContextGate_ledger_context_vacuousVacuityProof.lean; then
