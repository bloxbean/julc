...
inductive VacuousLedgerContextGateDatum where
  | Datum
deriving Repr

instance : IsData VacuousLedgerContextGateDatum where
  toData
...
inductive VacuousLedgerContextGateRedeemer where
  | Redeemer
deriving Repr

instance : IsData VacuousLedgerContextGateRedeemer where
  toData
