...
lake env lean -o .lake/build/lib/lean/VacuousCertificatePayload_certificate_vacuous_payloadObligation.olean VacuousCertificatePayload_certificate_vacuous_payloadObligation.lean

set +e
lake env lean VacuousCertificatePayload_certificate_vacuous_payloadNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean VacuousCertificatePayload_certificate_vacuous_payloadVacuityProof.lean; then
