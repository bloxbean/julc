...
lean_lib «GeneratedVerificationSupport» where
  roots := #[`GeneratedSchemas, `PropertyTemplates, `CheckedExecution, `SecurityProperty, `LedgerDomainEquivalence, `CertifyingSemanticsTests, `GenericCollectionsSemanticsTests, `LedgerContextSemanticsTests, `AuthorizationSemanticsTests]
