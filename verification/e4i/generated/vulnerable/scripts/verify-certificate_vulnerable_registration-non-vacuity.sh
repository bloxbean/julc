...
lake env lean -o .lake/build/lib/lean/VulnerableDRepRegistration_certificate_vulnerable_registrationObligation.olean VulnerableDRepRegistration_certificate_vulnerable_registrationObligation.lean

set +e
lake env lean VulnerableDRepRegistration_certificate_vulnerable_registrationNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean VulnerableDRepRegistration_certificate_vulnerable_registrationVacuityProof.lean; then
