...
lake env lean -o .lake/build/lib/lean/AuthorizedDRepRegistration_certificate_registration_depositObligation.olean AuthorizedDRepRegistration_certificate_registration_depositObligation.lean

set +e
lake env lean AuthorizedDRepRegistration_certificate_registration_depositNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean AuthorizedDRepRegistration_certificate_registration_depositVacuityProof.lean; then
