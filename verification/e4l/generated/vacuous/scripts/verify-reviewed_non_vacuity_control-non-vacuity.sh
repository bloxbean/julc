...
lake env lean -o .lake/build/lib/lean/VacuousReviewedAdapters_reviewed_non_vacuity_controlObligation.olean VacuousReviewedAdapters_reviewed_non_vacuity_controlObligation.lean

set +e
lake env lean VacuousReviewedAdapters_reviewed_non_vacuity_controlNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean VacuousReviewedAdapters_reviewed_non_vacuity_controlVacuityProof.lean; then
