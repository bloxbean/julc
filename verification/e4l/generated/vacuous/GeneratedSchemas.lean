...
structure VacuousReviewedAdaptersDatum where
  deadline : Integer
deriving Repr

instance : IsData VacuousReviewedAdaptersDatum where
...
inductive VacuousReviewedAdaptersRedeemer where
  | Redeemer
deriving Repr

instance : IsData VacuousReviewedAdaptersRedeemer where
  toData
