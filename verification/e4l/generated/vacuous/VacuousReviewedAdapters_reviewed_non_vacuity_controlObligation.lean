...
namespace JulcGenerated.VacuousReviewedAdapters_reviewed_non_vacuity_control
...
#import_uplc validator PlutusV3 double_cbor_hex
  "artifacts/vacuous-reviewed-adapters.compiledCode.hex"
...
def composedObligation : Prop :=
  ∀ ctx : ScriptContext,
    ...
    dslProperty_reviewed_non_vacuity_control ctx
...
end JulcGenerated.VacuousReviewedAdapters_reviewed_non_vacuity_control
