...
lake env lean -o .lake/build/lib/lean/AuthorizedReviewedAdapters_reviewed_treasury_calibrationObligation.olean AuthorizedReviewedAdapters_reviewed_treasury_calibrationObligation.lean

set +e
lake env lean AuthorizedReviewedAdapters_reviewed_treasury_calibrationNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean AuthorizedReviewedAdapters_reviewed_treasury_calibrationVacuityProof.lean; then
