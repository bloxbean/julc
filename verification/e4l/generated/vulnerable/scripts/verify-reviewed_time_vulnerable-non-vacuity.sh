...
lake env lean -o .lake/build/lib/lean/VulnerableReviewedAdapters_reviewed_time_vulnerableObligation.olean VulnerableReviewedAdapters_reviewed_time_vulnerableObligation.lean

set +e
lake env lean VulnerableReviewedAdapters_reviewed_time_vulnerableNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean VulnerableReviewedAdapters_reviewed_time_vulnerableVacuityProof.lean; then
