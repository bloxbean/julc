...
structure VulnerableReviewedAdaptersDatum where
  deadline : Integer
deriving Repr

instance : IsData VulnerableReviewedAdaptersDatum where
...
inductive VulnerableReviewedAdaptersRedeemer where
  | Redeemer
deriving Repr

instance : IsData VulnerableReviewedAdaptersRedeemer where
  toData
