...
lake env lean -o .lake/build/lib/lean/AuthorizedReviewedAdapters_reviewed_time_and_authorityObligation.olean AuthorizedReviewedAdapters_reviewed_time_and_authorityObligation.lean

set +e
lake env lean AuthorizedReviewedAdapters_reviewed_time_and_authorityNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean AuthorizedReviewedAdapters_reviewed_time_and_authorityVacuityProof.lean; then
