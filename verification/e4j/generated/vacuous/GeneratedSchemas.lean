...
inductive VacuousValueDatum where
  | Datum
deriving Repr

instance : IsData VacuousValueDatum where
  toData
...
inductive VacuousValueRedeemer where
  | Redeemer
deriving Repr

instance : IsData VacuousValueRedeemer where
  toData
