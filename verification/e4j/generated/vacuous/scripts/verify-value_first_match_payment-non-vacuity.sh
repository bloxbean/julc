...
lake env lean -o .lake/build/lib/lean/VacuousValue_value_first_match_paymentObligation.olean VacuousValue_value_first_match_paymentObligation.lean

set +e
lake env lean VacuousValue_value_first_match_paymentNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean VacuousValue_value_first_match_paymentVacuityProof.lean; then
