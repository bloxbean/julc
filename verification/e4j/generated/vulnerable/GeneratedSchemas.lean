...
inductive VulnerableValueDatum where
  | Datum
deriving Repr

instance : IsData VulnerableValueDatum where
  toData
...
inductive VulnerableValueRedeemer where
  | Redeemer
deriving Repr

instance : IsData VulnerableValueRedeemer where
  toData
