...
lake env lean -o .lake/build/lib/lean/VulnerableValue_value_first_match_paymentObligation.olean VulnerableValue_value_first_match_paymentObligation.lean

set +e
lake env lean VulnerableValue_value_first_match_paymentNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean VulnerableValue_value_first_match_paymentVacuityProof.lean; then
