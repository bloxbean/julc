...
inductive AuthorizedValueDatum where
  | Datum
deriving Repr

instance : IsData AuthorizedValueDatum where
  toData
...
inductive AuthorizedValueRedeemer where
  | Redeemer
deriving Repr

instance : IsData AuthorizedValueRedeemer where
  toData
