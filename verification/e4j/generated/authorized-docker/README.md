...
This generator-owned workspace checks `AuthorizedValue` against `1` independently
named schema-3 properties from `/Users/satya/work/bloxbean/julc/verification/e4j/AuthorizedValueSpec.java`. The worker-produced AST was strictly
