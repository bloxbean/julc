...
lean_lib «GeneratedVerificationSupport» where
  roots := #[`GeneratedSchemas, `PropertyTemplates, `CheckedExecution, `SecurityProperty, `LedgerDomainEquivalence, `GenericCollectionsSemanticsTests, `LedgerContextSemanticsTests, `AuthorizationSemanticsTests, `ValueAlgebraSemanticsTests]
