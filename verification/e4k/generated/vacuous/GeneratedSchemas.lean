...
inductive VacuousGovernanceDatum where
  | Datum
deriving Repr

instance : IsData VacuousGovernanceDatum where
  toData
...
inductive VacuousGovernanceRedeemer where
  | Redeemer
deriving Repr

instance : IsData VacuousGovernanceRedeemer where
  toData
