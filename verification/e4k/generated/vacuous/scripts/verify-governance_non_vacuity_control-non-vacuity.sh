...
lake env lean -o .lake/build/lib/lean/VacuousGovernance_governance_non_vacuity_controlObligation.olean VacuousGovernance_governance_non_vacuity_controlObligation.lean

set +e
lake env lean VacuousGovernance_governance_non_vacuity_controlNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean VacuousGovernance_governance_non_vacuity_controlVacuityProof.lean; then
