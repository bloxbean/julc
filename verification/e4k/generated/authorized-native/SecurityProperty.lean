...
def dslGuarantee_governance_minimum_deposit (ctx : ScriptContext) : Bool :=
...
def dslProperty_governance_minimum_deposit (ctx : ScriptContext) : Prop :=
  dslGuarantee_governance_minimum_deposit ctx = true
