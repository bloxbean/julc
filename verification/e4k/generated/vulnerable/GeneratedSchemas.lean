...
inductive VulnerableGovernanceDatum where
  | Datum
deriving Repr

instance : IsData VulnerableGovernanceDatum where
  toData
...
inductive VulnerableGovernanceRedeemer where
  | Redeemer
deriving Repr

instance : IsData VulnerableGovernanceRedeemer where
  toData
