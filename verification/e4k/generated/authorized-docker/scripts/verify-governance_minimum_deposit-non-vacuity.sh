...
lake env lean -o .lake/build/lib/lean/AuthorizedGovernance_governance_minimum_depositObligation.olean AuthorizedGovernance_governance_minimum_depositObligation.lean

set +e
lake env lean AuthorizedGovernance_governance_minimum_depositNonVacuityCounterexample.lean
witness_status=$?
set -e
...
if lake env lean AuthorizedGovernance_governance_minimum_depositVacuityProof.lean; then
