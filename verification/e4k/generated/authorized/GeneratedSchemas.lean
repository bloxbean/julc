...
inductive AuthorizedGovernanceDatum where
  | Datum
deriving Repr

instance : IsData AuthorizedGovernanceDatum where
  toData
...
inductive AuthorizedGovernanceRedeemer where
  | Redeemer
deriving Repr

instance : IsData AuthorizedGovernanceRedeemer where
  toData
