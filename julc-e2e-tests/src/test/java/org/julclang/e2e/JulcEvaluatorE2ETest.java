...
class JulcEvaluatorE2ETest extends E2ETestBase {
    ...
    void v2_spending_julcEvaluator_computesBudget() throws Exception {
        ...
        var v2Term = org.julclang.core.Term.lam("d",
                org.julclang.core.Term.lam("r",
                        org.julclang.core.Term.lam("ctx",
                                org.julclang.core.Term.const_(
                                        org.julclang.core.Constant.unit()))));
        var v2Program = org.julclang.core.Program.plutusV2(v2Term);
        byte[] v2FlatBytes = org.julclang.core.flat.UplcFlatEncoder.encodeProgram(v2Program);
    ...
    void v3_spending_nonTrivialValidator() throws Exception {
        ...
        //           (delay (con unit ()))
        //           (delay error))
        var ctx = org.julclang.core.Term.var(
                new org.julclang.core.NamedDeBruijn("ctx", 1));

        // unConstrData(ctx) -> Pair(tag, fields)
        var unConstr = org.julclang.core.Term.apply(
                org.julclang.core.Term.builtin(
                        org.julclang.core.DefaultFun.UnConstrData), ctx);

        // sndPair(unConstrData(ctx)) -> fields list
        var fields = org.julclang.core.Term.apply(
                org.julclang.core.Term.force(
                        org.julclang.core.Term.force(
                                org.julclang.core.Term.builtin(
                                        org.julclang.core.DefaultFun.SndPair))),
                unConstr);

        // tailList(fields) -> skip txInfo, rest starts with redeemer
        var tail = org.julclang.core.Term.apply(
                org.julclang.core.Term.force(
                        org.julclang.core.Term.builtin(
                                org.julclang.core.DefaultFun.TailList)),
                fields);

        // headList(tail) -> redeemer (PlutusData)
        var redeemer = org.julclang.core.Term.apply(
                org.julclang.core.Term.force(
                        org.julclang.core.Term.builtin(
                                org.julclang.core.DefaultFun.HeadList)),
                tail);

        // unIData(redeemer) -> Integer
        var value = org.julclang.core.Term.apply(
                org.julclang.core.Term.builtin(
                        org.julclang.core.DefaultFun.UnIData),
                redeemer);

        // equalsInteger(value, 42)
        var check = org.julclang.core.Term.apply(
                org.julclang.core.Term.apply(
                        org.julclang.core.Term.builtin(
                                org.julclang.core.DefaultFun.EqualsInteger),
                        value),
                org.julclang.core.Term.const_(
                        org.julclang.core.Constant.integer(42)));

        // ifThenElse check (delay (con unit ())) (delay error)
        var ite = org.julclang.core.Term.force(
                org.julclang.core.Term.apply(
                        org.julclang.core.Term.apply(
                                org.julclang.core.Term.apply(
                                        org.julclang.core.Term.force(
                                                org.julclang.core.Term.builtin(
                                                        org.julclang.core.DefaultFun.IfThenElse)),
                                        check),
                                org.julclang.core.Term.delay(
                                        org.julclang.core.Term.const_(
                                                org.julclang.core.Constant.unit()))),
                        org.julclang.core.Term.delay(
                                org.julclang.core.Term.error())));

        var validator = org.julclang.core.Term.lam("ctx", ite);
        var program = org.julclang.core.Program.plutusV3(validator);
