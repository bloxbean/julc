package org.julclang.tools.api;
...
public final class InputValidator {
    ...
    public static final int MAX_SOURCE_LENGTH = 100_000;      // 100 KB
    public static final int MAX_LIBRARY_LENGTH = 100_000;      // 100 KB
    public static final int MAX_EXPRESSION_LENGTH = 10_000;    // 10 KB
     ...
     */
    public static String validateLibrary(String librarySource) {
     ...
     */
    public static String sanitizeError(String prefix) {
        return prefix;
    }
}
