package org.julclang.decompiler.codegen;

import org.julclang.core.DefaultFun;
import org.julclang.decompiler.hir.HirTerm;
import org.julclang.decompiler.hir.HirType;
...
public final class JavaCodeGenerator {
    ...
    private static class Generator {
        ...
        void generateClass(HirTerm hir, ScriptAnalyzer.ScriptStats stats) {
            ...
            // Imports
            imports.add("org.julclang.core.Builtins");
        ...
        void emitDataLiteral(HirTerm.DataLiteral dl) {
            var data = dl.value();
            switch (data) {
                case org.julclang.core.PlutusData.IntData i ->
                        sb.append("PlutusData.integer(").append(i.value()).append(")");
                case org.julclang.core.PlutusData.BytesData b -> {
                    byte[] bytes = b.value();
                    if (bytes.length == 0) {
                ...
                case org.julclang.core.PlutusData.ListData l -> {
                    if (l.items().isEmpty()) {
                ...
                case org.julclang.core.PlutusData.MapData m -> {
                ...
                case org.julclang.core.PlutusData.ConstrData c -> {
