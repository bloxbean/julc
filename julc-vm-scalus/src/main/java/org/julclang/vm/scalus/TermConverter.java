package org.julclang.vm.scalus;
...
final class TermConverter {
    ...
    static org.julclang.core.DefaultUni fromScalusDefaultUni(scalus.uplc.DefaultUni uni) {
        if (uni == scalus.uplc.DefaultUni.Integer$.MODULE$) return org.julclang.core.DefaultUni.INTEGER;
        if (uni == scalus.uplc.DefaultUni.ByteString$.MODULE$) return org.julclang.core.DefaultUni.BYTESTRING;
        if (uni == scalus.uplc.DefaultUni.String$.MODULE$) return org.julclang.core.DefaultUni.STRING;
        if (uni == scalus.uplc.DefaultUni.Unit$.MODULE$) return org.julclang.core.DefaultUni.UNIT;
        if (uni == scalus.uplc.DefaultUni.Bool$.MODULE$) return org.julclang.core.DefaultUni.BOOL;
        if (uni == scalus.uplc.DefaultUni.Data$.MODULE$) return org.julclang.core.DefaultUni.DATA;
        if (uni == scalus.uplc.DefaultUni.BLS12_381_G1_Element$.MODULE$) {
            return org.julclang.core.DefaultUni.BLS12_381_G1;
        }
        if (uni == scalus.uplc.DefaultUni.BLS12_381_G2_Element$.MODULE$) {
            return org.julclang.core.DefaultUni.BLS12_381_G2;
        }
        if (uni == scalus.uplc.DefaultUni.BLS12_381_MlResult$.MODULE$) {
            return org.julclang.core.DefaultUni.BLS12_381_ML;
        }
        if (uni == scalus.uplc.DefaultUni.ProtoList$.MODULE$) return new org.julclang.core.DefaultUni.ProtoList();
        if (uni == scalus.uplc.DefaultUni.ProtoPair$.MODULE$) return new org.julclang.core.DefaultUni.ProtoPair();
        if (uni == scalus.uplc.DefaultUni.ProtoArray$.MODULE$) return new org.julclang.core.DefaultUni.ProtoArray();
        if (uni == scalus.uplc.DefaultUni.BuiltinValue$.MODULE$) return new org.julclang.core.DefaultUni.ProtoValue();
        if (uni instanceof scalus.uplc.DefaultUni.Apply a) {
            return new org.julclang.core.DefaultUni.Apply(
