...
| `./gradlew :julc-vm-scalus:test --rerun-tasks --no-daemon` | Success; 312 tests, 0 failures, 0 errors, 0 skipped | 1 min 28 s |
| `./gradlew :julc-vm:test :julc-vm-java:test :julc-vm-truffle:test :julc-vm-scalus:test --rerun-tasks --no-daemon` | Success | 1 min 36 s |
| `./gradlew :julc-testkit:test :julc-cardano-client-lib:test --rerun-tasks --no-daemon` | Success; 395 tests, 0 failures, 0 errors, 0 skipped | 14 s |
| `./gradlew build --no-daemon` | Success; 217 actionable tasks (3 executed, 214 up-to-date) | 6 s |
