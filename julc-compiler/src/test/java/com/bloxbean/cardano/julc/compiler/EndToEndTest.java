...
/**
 * End-to-end tests: compile PIR/UPLC -> evaluate via JulcVm -> verify results.
 */
class EndToEndTest {
    ...
    class ArithmeticTests {
        ...
        void addTwoNumbers() {
            ...
            assertInstanceOf(Term.Const.class, ((com.bloxbean.cardano.julc.vm.EvalResult.Success) result).resultTerm());
            var val = ((Term.Const) ((com.bloxbean.cardano.julc.vm.EvalResult.Success) result).resultTerm()).value();
    ...
    class BooleanLogicTests {
        ...
        void lessThanTrue() {
            ...
            var result = vm.evaluate(Program.plutusV3(term));
            assertTrue(result.isSuccess());
            assertTrue(((Constant.BoolConst) ((Term.Const) ((com.bloxbean.cardano.julc.vm.EvalResult.Success) result).resultTerm()).value()).value());
        }
    }
