            ...
            private Optional<PirTerm> resolve(
                ...
                if ("ContextsLib".equals(className)
                    ...
                    var sigListVar = new PirTerm.Var(
                            "sigList_sb",
                            new org.julclang.compiler.pir.PirType.ListType(
                                    new org.julclang.compiler.pir.PirType.DataType()));
                    var targetVar = new PirTerm.Var(
                            "target_sb",
                            new org.julclang.compiler.pir.PirType.ByteStringType());
                    var goVar = new PirTerm.Var(
                            "go_sb",
                            new org.julclang.compiler.pir.PirType.FunType(
                                    new org.julclang.compiler.pir.PirType.ListType(
                                            new org.julclang.compiler.pir.PirType
                                                    .DataType()),
