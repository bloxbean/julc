...
class EndToEndTest {
    ...
    class ArithmeticTests {
        ...
        void addTwoNumbers() {
            ...
            assertInstanceOf(Term.Const.class, ((org.julclang.vm.EvalResult.Success) result).resultTerm());
            var val = ((Term.Const) ((org.julclang.vm.EvalResult.Success) result).resultTerm()).value();
    ...
    class BooleanLogicTests {
        ...
        void lessThanTrue() {
            ...
            var result = vm.evaluate(Program.plutusV3(term));
            assertTrue(result.isSuccess());
            assertTrue(((Constant.BoolConst) ((Term.Const) ((org.julclang.vm.EvalResult.Success) result).resultTerm()).value()).value());
        }
    }
