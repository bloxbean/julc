package org.julclang.compiler.error;
...
class ErrorQualityTest {
    ...
    void typeMethodRegistryErrorMessagesIncludeUsageHints() {
        ...
        try {
            ...
            var registry = org.julclang.compiler.pir.TypeMethodRegistry.defaultRegistry();
            var scope = new org.julclang.compiler.pir.PirTerm.Const(
                    new org.julclang.core.Constant.UnitConst());
            var scopeType = new org.julclang.compiler.pir.PirType.ListType(
                    new org.julclang.compiler.pir.PirType.DataType());
