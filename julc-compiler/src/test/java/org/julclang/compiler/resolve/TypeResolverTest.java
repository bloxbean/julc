...
class TypeResolverTest {
    ...
    private void registerLedgerTypes(TypeResolver tr) {
        ...
        tr.addFlatVariantAliases("org.julclang.ledger");
    }
    ...
    class DynamicLedgerRegistrationTests {
        ...
        void flatVariantAliasesWork() {
            ...
            // Inner-class FQCN
            var innerLookup = tr.lookupSumTypeForVariant("org.julclang.ledger.Credential.PubKeyCredential");
            ...
            var flatLookup = tr.lookupSumTypeForVariant("org.julclang.ledger.PubKeyCredential");
        ...
        void delegateeVariantsRegistered() {
            ...
            var delegateeVote = tr.lookupSumTypeForVariant(
                    "org.julclang.ledger.Delegatee.Vote");
