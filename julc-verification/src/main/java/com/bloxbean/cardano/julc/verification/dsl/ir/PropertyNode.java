...
@JsonSubTypes({
        ...
        @JsonSubTypes.Type(value = StrictDecodeNode.class, name = "strict-decode"),
        ...
        @JsonSubTypes.Type(value = ListSingletonWhenNode.class, name = "list-singleton-when"),
        ...
        @JsonSubTypes.Type(value = ValueEntriesNode.class, name = "value-entries"),
...
public sealed interface PropertyNode permits RootNode, FieldNode, BoolBinaryNode,
        ...
        VariantWhenNode, StrictDecodeNode, BoolLiteralNode, BoolNotNode,
        IntegerArithmeticNode,
        TypedEqualityNode, OptionStateNode, ListStateNode, ListQuantifierNode,
        ListSingletonWhenNode,
