...
import org.julclang.verification.dsl.ir.ValueArithmeticNode;
import org.julclang.verification.dsl.ir.ValueRelationNode;
...
public record ValueDeltaExpr(PropertyNode node) implements Expr {
    ...
    public ValueDeltaOptionExpr scale(IntegerExpr factor) {
        ...
        if (!(factor.node() instanceof org.julclang.verification.dsl.ir.LiteralNode
