    ...
    private static final class TypedModelGenerator {
        ...
        private String generate() {
            ...
            body.append("package ").append(packageName).append(";\n\n")
                    .append("import org.julclang.verification.dsl.*;\n")
                    .append("import org.julclang.verification.dsl.ir.*;\n")
                    .append("import org.julclang.verification.dsl.type.*;\n")
            ...
            if (projection.purpose() == org.julclang.compiler.schema
