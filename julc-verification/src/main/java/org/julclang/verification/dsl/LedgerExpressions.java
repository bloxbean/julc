...
import org.julclang.verification.dsl.ir.LedgerRootNode;
import org.julclang.verification.dsl.ir.LedgerByteAliasNode;
...
public final class LedgerExpressions {
    ...
    public static IntegerExpr currentCertificateIndex() {
        return new IntegerExpr(new org.julclang.verification.dsl.ir.RootNode(
                "certificateIndex",
                org.julclang.verification.dsl.ir.DslType.INTEGER));
    }
    ...
    public static ValueDeltaOptionExpr singletonValueDelta(
        ...
        return ValueAlgebra.arithmetic(
                org.julclang.verification.dsl.ir.ValueArithmeticNode
    ...
    private static LedgerByteAliasExpr alias(
            ...
            org.julclang.verification.dsl.type.LedgerTypeRef type) {
