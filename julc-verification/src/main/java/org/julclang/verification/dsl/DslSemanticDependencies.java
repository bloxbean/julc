...
import org.julclang.verification.capability.CapabilityStatus;
import org.julclang.verification.capability.LedgerCapabilityInventories;
...
public final class DslSemanticDependencies {
    ...
    private static String strictDecodeRule(StrictDecodeNode decoded) {
        if (!(decoded.decodedType()
                instanceof org.julclang.verification.dsl.type.NominalTypeRef
                nominal)) {
            throw new IllegalArgumentException(
