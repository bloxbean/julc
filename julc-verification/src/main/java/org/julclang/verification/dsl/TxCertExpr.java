...
import org.julclang.verification.dsl.ir.LedgerVariantFieldNode;
import org.julclang.verification.dsl.ir.LedgerVariantIsNode;
import org.julclang.verification.dsl.ir.LedgerVariantWhenNode;
...
import org.julclang.verification.dsl.ir.TxCertKindNode;
...
public record TxCertExpr(PropertyNode node) implements Expr {
    ...
    public BoolExpr isKind(TxCertKind kind) {
        ...
        if (!(node instanceof org.julclang.verification.dsl.ir.RootNode)) {
    ...
    private static LedgerIntegerOptionExpr optionalInteger(
        ...
        return new LedgerIntegerOptionExpr(new LedgerVariantFieldNode(bound,
                LedgerTypeAuthority.TX_CERT, constructor, field,
                new org.julclang.verification.dsl.type.OptionalTypeRef(
