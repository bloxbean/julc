package org.julclang.jrl.transpile;

import org.julclang.jrl.ast.*;
...
public final class JavaTranspiler {
    ...
    private void emitImports() {
        emitLine("import org.julclang.stdlib.annotation.*;");
        emitLine("import org.julclang.ledger.*;");
        emitLine("import org.julclang.stdlib.lib.*;");
        emitLine("import org.julclang.stdlib.Builtins;");
        emitLine("import org.julclang.core.PlutusData;");
