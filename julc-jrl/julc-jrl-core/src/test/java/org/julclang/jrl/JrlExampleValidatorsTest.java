...
/**
 * End-to-end tests for JRL example validators.
...
class JrlExampleValidatorsTest {
    ...
    class SimpleTransferTests {
        ...
        @BeforeAll
        void compileOnce() {
            program = JrlTestSupport.compileJrl(JrlTestSupport.loadJrl("SimpleTransfer.jrl"))
    ...
    class VestingTests {
        ...
        @BeforeAll
        void compileOnce() {
            program = JrlTestSupport.compileJrl(JrlTestSupport.loadJrl("Vesting.jrl"));
        }
    ...
    class MultiSigTreasuryTests {
        ...
        @BeforeAll
        void compileOnce() {
            program = JrlTestSupport.compileJrl(JrlTestSupport.loadJrl("MultiSigTreasury.jrl"));
        }
    ...
    class MultiSigMintingTests {
        ...
        @BeforeAll
        void compileOnce() {
            program = JrlTestSupport.compileJrl(JrlTestSupport.loadJrl("MultiSigMinting.jrl"))
                    .applyParams(
    ...
    class HtlcTests {
        ...
        @BeforeAll
        void compileOnce() {
            program = JrlTestSupport.compileJrl(JrlTestSupport.loadJrl("HTLC.jrl"))
                    .applyParams(
    ...
    class TimeLockTests {
        ...
        @BeforeAll
        void compileOnce() {
            program = JrlTestSupport.compileJrl(JrlTestSupport.loadJrl("TimeLock.jrl"))
                    .applyParams(
                            PlutusData.bytes(PKH1),       // owner
